        ...
        return(
                <div className="navmodal" data-aos="fade-in">
                    ...
                    <Grid.Row >
                        <Grid.Column>
                        <div style={{}} >
                        <p style={{fontSize:"2em"}}> <Icon color="orange" name="cube" /> <span  className="open-sans2" >REACTANGLE</span> <Icon name="cancel" style={{float:"right"}} className="xcursor" onClick={()=>this.props.handleClose()}/></p>
                        </div>
                        </Grid.Column>
                    </Grid.Row>
                    <Grid.Row className="modal-links">
                        ...
                        <Grid.Row >
                                ...
                                <Grid.Row >
                                <Grid.Column>
                                <Button inverted  icon="calendar" circular size="big" floated="left"/>
