    ...
    render() { 
        ...
        return (
                     ...
                     <i className="fa fa-circle-o" style={{fontSize:"0.6em"}}></i> <i className="fa fa-circle-o" style={{fontSize:"0.6em"}} ></i>   <i className="fa fa-circle-o" style={{fontSize:"0.6em"}}></i>
                      ...
                      <div className={classnames("option-menu",this.state.showOption?"":"hide")} style={{background:"#fff",position:"absolute",marginTop:"10px",right:0,border:"1px solid #e8e8e8",padding:"10px 15px",fontSize:"0.8em"}}>
