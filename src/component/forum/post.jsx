    ...
    render() {
        ...
        return (
            <div className="row">
                ...
                <Intro user={this.props.auth.user} {...this.props}/>
...
<div className="row white forumupload">
                ...
                <div className="col-sm-10 zero" style={{marginBottom:"15px"}}>
                        <input type="text" name="title"  onChange={this.typing} className="form-control"  placeholder="" />
                </div>
                <div className="col-sm-2">
                   <b>Section</b>
                </div>
