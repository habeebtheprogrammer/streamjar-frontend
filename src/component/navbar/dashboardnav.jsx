...
<div className="dashboard-nav">
    <div className="dashboard-nav-inner">
        ...
        <ul>
            ...
            <li className={classnames(this.props.location.pathname === this.props.match.url+"/settings"? "active":null)}><Link to={`${this.props.match.url}/settings`}><i className="sl sl-icon-settings"></i> Settings</Link></li>
