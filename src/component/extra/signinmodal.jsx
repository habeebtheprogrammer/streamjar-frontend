...
export default class Signinmodal extends Component{
	...
	<div className="svgContainer">
		<div>
			<svg className="mySVG" xmlns="http://www.w3.org/2000/svg" link="http://www.w3.org/1999/xlink" viewBox="0 0 200 200">
				<defs>
				...
				<circle cx="100" cy="100" r="100" fill="#ed2553"/>
				<g className="body">
						...
						<div className="tab-content" id="tab2" style={{display: "none"}}>
							...
							<p className="form-row form-row-wide">
								...
								<label for="Phone">Phone Number:
									...
									<input type="number" className="input-text" name="Phone" id="Phone" value="" />
								</label>
							</p>
